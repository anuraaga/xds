...
const file_xds_core_v3_authority_proto_rawDesc = "" +
	"\n" +
	"\x1bxds/core/v3/authority.proto\x12\vxds.core.v3\x1a\x1fxds/annotations/v3/status.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"/\n" +
	"\tAuthority\x12\"\n" +
	"\x04name\x18\x01 \x01(\tB\x0e\xfaB\x04r\x02\x10\x01\xbaH\x04r\x02\x10\x01R\x04nameBV\xd2Ƥ\xe1\x06\x02\b\x01\n" +
