...
const file_xds_core_v3_resource_locator_proto_rawDesc = "" +
	"\n" +
	"\"xds/core/v3/resource_locator.proto\x12\vxds.core.v3\x1a\x1fxds/annotations/v3/status.proto\x1a xds/core/v3/context_params.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\xc1\x04\n" +
	"\x0fResourceLocator\x12M\n" +
	"\x06scheme\x18\x01 \x01(\x0e2#.xds.core.v3.ResourceLocator.SchemeB\x10\xfaB\x05\x82\x01\x02\x10\x01\xbaH\x05\x82\x01\x02\x10\x01R\x06scheme\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12\x1c\n" +
	"\tauthority\x18\x03 \x01(\tR\tauthority\x123\n" +
	"\rresource_type\x18\x04 \x01(\tB\x0e\xfaB\x04r\x02\x10\x01\xbaH\x04r\x02\x10\x01R\fresourceType\x12A\n" +
	...
	"directives\x1a\xac\x01\n" +
	"\tDirective\x120\n" +
	"\x03alt\x18\x01 \x01(\v2\x1c.xds.core.v3.ResourceLocatorH\x00R\x03alt\x12V\n" +
	"\x05entry\x18\x02 \x01(\tB>\xfaB\x1cr\x1a\x10\x012\x16^[0-9a-zA-Z_\\-\\./~:]+$\xbaH\x1cr\x1a\x10\x012\x16^[0-9a-zA-Z_\\-\\./~:]+$H\x00R\x05entryB\x15\n" +
	"\tdirective\x12\b\xf8B\x01\xbaH\x02\b\x01\"'\n" +
	"\x06Scheme\x12\t\n" +
