...
const file_xds_core_v3_cidr_proto_rawDesc = "" +
	"\n" +
	"\x16xds/core/v3/cidr.proto\x12\vxds.core.v3\x1a\x1fxds/annotations/v3/status.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\x91\x01\n" +
	"\tCidrRange\x125\n" +
	"\x0eaddress_prefix\x18\x01 \x01(\tB\x0e\xfaB\x04r\x02\x10\x01\xbaH\x04r\x02\x10\x01R\raddressPrefix\x12M\n" +
	"\n" +
	"prefix_len\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueB\x10\xfaB\x05*\x03\x18\x80\x01\xbaH\x05*\x03\x18\x80\x01R\tprefixLenBN\n" +
