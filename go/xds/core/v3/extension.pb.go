...
const file_xds_core_v3_extension_proto_rawDesc = "" +
	"\n" +
	"\x1bxds/core/v3/extension.proto\x12\vxds.core.v3\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\x1a\x19google/protobuf/any.proto\"\x83\x01\n" +
	"\x14TypedExtensionConfig\x12\"\n" +
	"\x04name\x18\x01 \x01(\tB\x0e\xfaB\x04r\x02\x10\x01\xbaH\x04r\x02\x10\x01R\x04name\x12G\n" +
	"\ftyped_config\x18\x02 \x01(\v2\x14.google.protobuf.AnyB\x0e\xfaB\x05\xa2\x01\x02\b\x01\xbaH\x03\xc8\x01\x01R\vtypedConfigBN\n" +
