...
const file_xds_core_v3_collection_entry_proto_rawDesc = "" +
	"\n" +
	"\"xds/core/v3/collection_entry.proto\x12\vxds.core.v3\x1a\x19google/protobuf/any.proto\x1a\x1fxds/annotations/v3/status.proto\x1a\"xds/core/v3/resource_locator.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\xe4\x02\n" +
	"\x0fCollectionEntry\x128\n" +
	"\alocator\x18\x01 \x01(\v2\x1c.xds.core.v3.ResourceLocatorH\x00R\alocator\x12M\n" +
	"\finline_entry\x18\x02 \x01(\v2(.xds.core.v3.CollectionEntry.InlineEntryH\x00R\vinlineEntry\x1a\xa7\x01\n" +
	"\vInlineEntry\x12L\n" +
	"\x04name\x18\x01 \x01(\tB8\xfaB\x19r\x172\x15^[0-9a-zA-Z_\\-\\.~:]+$\xbaH\x19r\x172\x15^[0-9a-zA-Z_\\-\\.~:]+$R\x04name\x12\x18\n" +
	"\aversion\x18\x02 \x01(\tR\aversion\x120\n" +
	"\bresource\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\bresourceB\x1e\n" +
	"\x12resource_specifier\x12\b\xf8B\x01\xbaH\x02\b\x01B\\\xd2Ƥ\xe1\x06\x02\b\x01\n" +
