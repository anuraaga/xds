...
const file_xds_core_v3_resource_name_proto_rawDesc = "" +
	"\n" +
	"\x1fxds/core/v3/resource_name.proto\x12\vxds.core.v3\x1a\x1fxds/annotations/v3/status.proto\x1a xds/core/v3/context_params.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\xa7\x01\n" +
	"\fResourceName\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1c\n" +
	"\tauthority\x18\x02 \x01(\tR\tauthority\x123\n" +
	"\rresource_type\x18\x03 \x01(\tB\x0e\xfaB\x04r\x02\x10\x01\xbaH\x04r\x02\x10\x01R\fresourceType\x124\n" +
