...
const file_xds_type_v3_cel_proto_rawDesc = "" +
	...
	"\x0eexpr_specifier\"\xa4\x01\n" +
	"\x10CelExtractString\x12M\n" +
	"\fexpr_extract\x18\x01 \x01(\v2\x1a.xds.type.v3.CelExpressionB\x0e\xfaB\x05\x8a\x01\x02\x10\x01\xbaH\x03\xc8\x01\x01R\vexprExtract\x12A\n" +
