...
const file_xds_type_matcher_v3_cel_proto_rawDesc = "" +
	"\n" +
	"\x1dxds/type/matcher/v3/cel.proto\x12\x13xds.type.matcher.v3\x1a\x15xds/type/v3/cel.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"y\n" +
	"\n" +
	"CelMatcher\x12I\n" +
	"\n" +
	"expr_match\x18\x01 \x01(\v2\x1a.xds.type.v3.CelExpressionB\x0e\xfaB\x05\x8a\x01\x02\x10\x01\xbaH\x03\xc8\x01\x01R\texprMatch\x12 \n" +
