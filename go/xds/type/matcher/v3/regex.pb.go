...
const file_xds_type_matcher_v3_regex_proto_rawDesc = "" +
	"\n" +
	"\x1fxds/type/matcher/v3/regex.proto\x12\x13xds.type.matcher.v3\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\xb2\x01\n" +
	"\fRegexMatcher\x12V\n" +
	"\n" +
	"google_re2\x18\x01 \x01(\v2+.xds.type.matcher.v3.RegexMatcher.GoogleRE2B\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\tgoogleRe2\x12$\n" +
	"\x05regex\x18\x02 \x01(\tB\x0e\xfaB\x04r\x02\x10\x01\xbaH\x04r\x02\x10\x01R\x05regex\x1a\v\n" +
	"\tGoogleRE2B\x17\n" +
	"\vengine_type\x12\b\xf8B\x01\xbaH\x02\b\x01BZ\n" +
