...
const file_xds_type_matcher_v3_range_proto_rawDesc = "" +
	"\n" +
	"\x1fxds/type/matcher/v3/range.proto\x12\x13xds.type.matcher.v3\x1a\x17xds/type/v3/range.proto\x1a!xds/type/matcher/v3/matcher.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\x84\x02\n" +
	"\x11Int64RangeMatcher\x12Z\n" +
	"\x0erange_matchers\x18\x01 \x03(\v23.xds.type.matcher.v3.Int64RangeMatcher.RangeMatcherR\rrangeMatchers\x1a\x92\x01\n" +
	"\fRangeMatcher\x12A\n" +
	"\x06ranges\x18\x01 \x03(\v2\x17.xds.type.v3.Int64RangeB\x10\xfaB\x05\x92\x01\x02\b\x01\xbaH\x05\x92\x01\x02\b\x01R\x06ranges\x12?\n" +
	"\bon_match\x18\x02 \x01(\v2$.xds.type.matcher.v3.Matcher.OnMatchR\aonMatch\"\x84\x02\n" +
	"\x11Int32RangeMatcher\x12Z\n" +
	"\x0erange_matchers\x18\x01 \x03(\v23.xds.type.matcher.v3.Int32RangeMatcher.RangeMatcherR\rrangeMatchers\x1a\x92\x01\n" +
	"\fRangeMatcher\x12A\n" +
	"\x06ranges\x18\x01 \x03(\v2\x17.xds.type.v3.Int32RangeB\x10\xfaB\x05\x92\x01\x02\b\x01\xbaH\x05\x92\x01\x02\b\x01R\x06ranges\x12?\n" +
	"\bon_match\x18\x02 \x01(\v2$.xds.type.matcher.v3.Matcher.OnMatchR\aonMatch\"\x87\x02\n" +
	"\x12DoubleRangeMatcher\x12[\n" +
	"\x0erange_matchers\x18\x01 \x03(\v24.xds.type.matcher.v3.DoubleRangeMatcher.RangeMatcherR\rrangeMatchers\x1a\x93\x01\n" +
	"\fRangeMatcher\x12B\n" +
	"\x06ranges\x18\x01 \x03(\v2\x18.xds.type.v3.DoubleRangeB\x10\xfaB\x05\x92\x01\x02\b\x01\xbaH\x05\x92\x01\x02\b\x01R\x06ranges\x12?\n" +
