...
const file_xds_type_matcher_v3_ip_proto_rawDesc = "" +
	"\n" +
	"\x1cxds/type/matcher/v3/ip.proto\x12\x13xds.type.matcher.v3\x1a\x1fxds/annotations/v3/status.proto\x1a\x16xds/core/v3/cidr.proto\x1a!xds/type/matcher/v3/matcher.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\x95\x02\n" +
	"\tIPMatcher\x12T\n" +
	"\x0erange_matchers\x18\x01 \x03(\v2-.xds.type.matcher.v3.IPMatcher.IPRangeMatcherR\rrangeMatchers\x1a\xb1\x01\n" +
	"\x0eIPRangeMatcher\x12@\n" +
	"\x06ranges\x18\x01 \x03(\v2\x16.xds.core.v3.CidrRangeB\x10\xfaB\x05\x92\x01\x02\b\x01\xbaH\x05\x92\x01\x02\b\x01R\x06ranges\x12?\n" +
