...
const file_xds_type_matcher_v3_domain_proto_rawDesc = "" +
	"\n" +
	" xds/type/matcher/v3/domain.proto\x12\x13xds.type.matcher.v3\x1a\x1fxds/annotations/v3/status.proto\x1a!xds/type/matcher/v3/matcher.proto\x1a\x17validate/validate.proto\x1a\x1bbuf/validate/validate.proto\"\xf0\x01\n" +
	"\x11ServerNameMatcher\x12]\n" +
	"\x0fdomain_matchers\x18\x01 \x03(\v24.xds.type.matcher.v3.ServerNameMatcher.DomainMatcherR\x0edomainMatchers\x1a|\n" +
	"\rDomainMatcher\x12*\n" +
	"\adomains\x18\x01 \x03(\tB\x10\xfaB\x05\x92\x01\x02\b\x01\xbaH\x05\x92\x01\x02\b\x01R\adomains\x12?\n" +
